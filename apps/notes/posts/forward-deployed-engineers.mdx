...
draft: false
description: The Palantir solution to "the system is the problem" was to parachute engineers into context to create an "end-to-end solution to that specific problem, and to hell with generalizability".
category: note
tags:
  - featured
...
If Nabeel's post resonates, you should also [read this](https://tedmabrey.substack.com/p/sorry-that-isnt-an-fde) linked from his footnotes:
